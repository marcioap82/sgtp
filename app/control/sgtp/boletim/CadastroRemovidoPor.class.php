 ...
 */
class CadastroRemovidoPor extends TPage
{
    protected $form; // form
    ...
    function __construct()
    {
        ...
        $this->form->setFormTitle('Dados removido por');
        $this->form->setColumnClasses(2, ['col-sm-3', 'col-sm-9']);
        
        // create the form fields
        $removido_por     = new TDBRadioGroup('nome', 'sgtran', 'RemovidoPor', 'id', 'nome');
    ...
    public function onNextForm()
    {
        try
        {
            ...
            AdiantiCoreApplication::loadPage('CadastroDeclaracaoCondutor', 'onLoadFromForm1', (array) $data);
    ...
    public function onBackForm()
    {
        ...
        AdiantiCoreApplication::loadPage('CadastroRemovidoPara','onLoadFromSession');
    }
