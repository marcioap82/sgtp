 ...
 */
class CadastroSituacaoHabilitacao extends TPage
{
    protected $form; // form
    ...
    function __construct()
    {
        ...
        $this->form->setFormTitle('Dados habilitação');
    ...
    public function onNextForm()
    {
        try
        {
            ...
            AdiantiCoreApplication::loadPage('CadastroVeiculo', 'onLoadFromForm1', (array) $data);
