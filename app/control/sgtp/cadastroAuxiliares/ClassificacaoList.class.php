...
class ClassificacaoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('Classificacao');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_Classificacao');
        $this->form->setFormTitle('Classificacao');
        ...
        $this->form->setData( TSession::getValue('Classificacao_filter_data') );
        
        // add the search form actions
        $btn = $this->form->addAction(_t('Find'), new TAction([$this, 'onSearch']), 'fa:search');
        $btn->class = 'btn btn-sm btn-primary';
        $this->form->addActionLink(_t('New'), new TAction(['ClassificacaoForm', 'onEdit']), 'fa:plus green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(['ClassificacaoForm', 'onEdit']);
