<?php
/**
 * SentidoDaViaList Listing
 * @author  <your name here>
 */
class SentidoDaViaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('SentidoDaVia');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_SentidoDaVia');
        $this->form->setFormTitle('SentidoDaVia');
        ...
        $this->form->setData( TSession::getValue('SentidoDaVia_filter_data') );
        
        // add the search form actions
        $btn = $this->form->addAction(_t('Find'), new TAction([$this, 'onSearch']), 'fa:search');
        $btn->class = 'btn btn-sm btn-primary';
        $this->form->addActionLink(_t('New'), new TAction(['SentidoDaViaForm', 'onEdit']), 'fa:plus green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(['SentidoDaViaForm', 'onEdit']);
