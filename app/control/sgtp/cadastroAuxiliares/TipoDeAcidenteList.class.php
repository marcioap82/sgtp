<?php
/**
 * TipoDeAcidenteList Listing
 * @author  <your name here>
 */
class TipoDeAcidenteList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setData( TSession::getValue('TipoDeAcidente_filter_data') );
        
        // add the search form actions
        $btn = $this->form->addAction(_t('Find'), new TAction([$this, 'onSearch']), 'fa:search');
        $btn->class = 'btn btn-sm btn-primary';
        $this->form->addActionLink(_t('New'), new TAction(['TipoDeAcidenteForm', 'onEdit']), 'fa:plus green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(['TipoDeAcidenteForm', 'onEdit']);
