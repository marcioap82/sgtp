<?php
/**
 * CodicaoDaViaList Listing
 * @author  <your name here>
 */
class CodicaoDaViaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('CodicaoDaVia');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_CodicaoDaVia');
        $this->form->setFormTitle('CodicaoDaVia');
        ...
        $this->form->setData( TSession::getValue('CodicaoDaVia_filter_data') );
        
        // add the search form actions
        $btn = $this->form->addAction(_t('Find'), new TAction([$this, 'onSearch']), 'fa:search');
        $btn->class = 'btn btn-sm btn-primary';
        $this->form->addActionLink(_t('New'), new TAction(['CodicaoDaViaForm', 'onEdit']), 'fa:plus green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(['CodicaoDaViaForm', 'onEdit']);
