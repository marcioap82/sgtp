...
class CadastroDadosAcidente extends TPage
{
    ...
    function __construct()
    {
        ...
        $condicao_tempo = new TDBCheckGroup('codicao_do_tempo_id', 'sgtp', 'CodicaoDoTempo', 'id', 'descricao');
        ...
        $tipo_pavimento->setSize(150);
        $condicao_via->setSize(130);
        $condicao_tempo->setSize(130);
        $controle_trafego->setSize(130);
    ...
    public function onNextForm()
    {
        try
        {
            ...
            print_r(TSession::getValue('form_data_acidente'));
        }
        catch (Exception $e)
        {
