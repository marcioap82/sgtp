...
class PessoaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->addFilterField('nome_guerra', 'like', 'nome_guerra'); // filterField, operator, formField
        ...
        $column_nome_guerra = new TDataGridColumn('nome_guerra', 'Nome de guerra', 'left');
        $column_cpf = new TDataGridColumn('cpf', 'CPF', 'left');
        $column_posto_graduacao = new TDataGridColumn('posto_graduacao', 'Posto / Graduação', 'left');
        $column_endereco = new TDataGridColumn('email', 'Email', 'left');
        ...
        $this->datagrid->addColumn($column_nome_guerra);
        $this->datagrid->addColumn($column_cpf);
        $this->datagrid->addColumn($column_posto_graduacao);
